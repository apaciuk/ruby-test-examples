# Test examples for ruby with RSpec

## About this repository

Examples from the Ruby course for The Odin Project. It contains a series of Ruby exercises alongside RSpec tests with the solution in a Test Driven Development experience.
